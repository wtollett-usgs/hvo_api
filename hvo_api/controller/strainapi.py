...
class StrainAPI(Resource):
        ...
        for channel in channels:
            ...
            if args['debias'] == 'mean':
                ...
                mbarometer = (sum([x.barometer for x in data])
                              / float(len(data)) if 'barometer' in series
                              else 0)
            else:
                m01 = 0
                m02 = 0
            ...
            for d in data:
                ...
                if 'barometer' in series:
                    a['barometer'] = ((d.barometer - mbarometer)
    ...
    def create_param_string():
        ...
        ranks = [{'rid': x.rid, 'name': x.name}
                 for x in strain.StrainRank.query.all()]
        params = {}
