...
_tablenames = ['BLB', 'ESC', 'HEI', 'HOK', 'IKI', 'JKA', 'KAE', 'KNP', 'KWL', 'MCC', 'MKI', 'MLO', 'MLS', 'MOK', 'MUL',
               'POC', 'POO', 'POS', 'SDH', 'SLC', 'SMC', 'TST', 'UWD', 'UWE', 'UWT', 'WBO']
...
for name in _tablenames:
    c = type(name.upper(), (TiltBase, db.Model), { '__bind_key__': 'tilt', '__tablename__': name })
