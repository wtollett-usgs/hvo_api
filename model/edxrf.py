...
class EDXRFBase(object):
    ...
    def translation(self):
        return db.relationship('EDXRFTranslation',
...
class EDXRFRank(db.Model):
    ...
    rid = db.Column(db.Integer, db.ForeignKey('KIERZ.rid'),
                    db.ForeignKey('KISUM.rid'), primary_key=True)
...
class EDXRFTranslation(db.Model):
    ...
    tid = db.Column(db.Integer, db.ForeignKey('KIERZ.tid'),
                    db.ForeignKey('KISUM.tid'), primary_key=True)
