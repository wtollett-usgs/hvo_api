...
class IncompatiblesBase(object):
    ...
    wr_la_yb_icpms = db.Column(db.Float)
...
class KERZ(IncompatiblesBase, db.Model):
    ...
    def __init__(self, time='', wr_k2o_tio2='', gls_k2o_tio2='', wr_cao_al2o3='', wr_cao_tio2='', wr_la_yb_inaa='',
                 wr_la_yb_icpms='', wr_zr_y_wdx='', wr_zr_y_edx='', wr_sr_edx='', sid=''):
        ...
        self.wr_la_yb_icpms = '%.3f' % float(wr_la_yb_icpms) if wr_la_yb_icpms != '' else None
